...
var city = "Miami";
var sentence = firstName+ " " +lastName+ " esta en " +city
//Question 3.2
//Write a sentence that uses the following variables
var totalPower = 32;
var generator = 1;
var sentence = totalPower+ " " + " cars estan en  " +generator+ "  parking"
...
var years = 30;
  ...
  for (var anoCorriente =1; anoCorriente <=years; anoCorriente++){
var money = money*(1+interest);
    console.log("Al terminar el ano "+anoCorriente+", usted tiene "+(money*(1+interest))+" ");
...
// var mileage = 150000;
// var brand = "Kia";
// if ( var carAge =10; mileage > 150000; brand = Kia){
...
La contadora le pidio que haga un reporte de cuanto galones gasta por dia,
que depende en las piscinas operacionales.  Hoy toda las piscinas estan trabajando.
*/
